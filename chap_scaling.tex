...
\begin{table}[t]
    ...
    \begin{tabular}{c l l}
        ...
        % -------------------------------------------------------------------------- %
        %\midrule
        %\multicolumn{3}{c}{\itshape Paramètres de nuisance: données} \\
        %\midrule
        %$(X_i, Y_i)$ & Valeurs réelles des estimateurs & $\mathcal{N}_{\rm 2D}(\{x_i, y_i\}, V_i$) \\
        % -------------------------------------------------------------------------- %
        \bottomrule
    \end{tabular}
    \caption{%
...
Comme nous l'avons vu en section \mypageref{sec:cluster_nbcount}, cette probabilité peut être utilisée pour l'étalonnage en masse d'un échantillon d'amas de galaxies en vue de son exploitation cosmologique (équation \ref{eq:nbcount_obs}).
...
Les incertitudes relatives sur les paramètres de la relation d'échelle pour 5000 réalisations d'échantillons comportant cette extension sont présentés en rouge sur la figure \ref{fig:scaling:eta_ext}.
