%\begin{flushright}
%    \small
%    \textit{Une intro, ça commence par \guillemotleft De tout temps l'Homme s'est intéressé à la cosmologie avec des amas. \guillemotright} \footnote{C'est une blague, je l'enlève après...}\\
%    -- Anonyme, 2021
%    \normalsize
%\end{flushright}
