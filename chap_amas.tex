...
\footnotetext{Le signal SZ étant largement sous-dominant dans les relevés du ciel par rapport aux signaux contaminants (comme l'atmosphère) ou astrophysiques (comme les anisotropies primaires du CMB), le spectre de puissance des cartes de bruit $\mathbf{N}(\vec{x})$ sont en général supposés égaux à ceux des cartes complètes $\mathbf{M}(\vec{x})$.}
